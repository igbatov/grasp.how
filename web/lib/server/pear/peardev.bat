...
FOR %%x IN ("C:\Documents and Settings\igbatov\remote\pear\pear\php") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Documents and Settings\igbatov\remote\pear\pear\php"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Documents and Settings\igbatov\remote\pear\pear"
