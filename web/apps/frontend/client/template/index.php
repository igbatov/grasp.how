...
<div class="box2">
  <div class="container padding50">
    ...
    <div class="col-sm-7 noleft">
      ...
      <p>Читая текст зачастую сложно оценить правдоподобность утверждений автора. Нужно выделить факты, на которых основаны утверждения, определить их достоверность, понять все ли сведения учтены, проверить логические связи.</p>
      ...
      <p>Карты доступны для совместного редактирования. Это значит что вместо размытых комментариев читатели смогут присылать конструктивные дополнения к вашей статье.</p>
    </div>
