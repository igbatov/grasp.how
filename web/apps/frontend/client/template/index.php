...
<div class="box1">
  <div class="container">
    <h1>
        Карты фактов для анализа информации
    ...
    <div id="grasp-how-501cb8beb66019e90ed669caadbe7ad4" style="height: 500px;">
        <script src='http://www.grasp.how/embed.js?data=39/1640499761'></script>
</div>
  </div>
</div>
<div class="box2">
  <div class="container padding50">
    <div id="goal" class="col-sm-12 nopadding">
      <h2>Зачем нужны карты фактов?</h2>
    </div>
    <div class="col-sm-7 noleft">
      ...
      <p>Карты фактов grasp.how помогают понять взаимосвязи фактов и утверждений
      ...
      <div class="col-sm-6 noright">
        <div class="inner">
	     <div class="web-cam">
	       ...
	       <?php else: ?>
             <video class="firstVideo" loop autobuffer muted playsinline>
      ...
      <div class="col-sm-6 noright">
        <div class="inner">
          <div class="web-cam">
            ...
            <?php else: ?>
            <video class="secondVideo" loop autobuffer muted playsinline>
      ...
      <div class="col-sm-6 noleft">
        <div class="inner">
          <div class="web-cam">
            ...
            <?php else: ?>
            <video class="thirdVideo" loop autobuffer muted playsinline>
