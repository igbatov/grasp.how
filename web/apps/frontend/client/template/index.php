...
<div class="box2">
  <div class="container padding50">
    ...
    <div class="col-sm-7 noleft">
      ...
      <p>Часто сложно оценить правдоподобность утверждений автора, читая текст полный описаний и лирических отступлений. Сложно выделить факты, на которых основаны утверждения, определить их достоверность и проверить логические связи.</p>

      <p>Визуальные карты grasp.how помогают понять взаимосвязи фактов и утверждений в тексте и показывают, что тексту можно доверять.</p>

      <p>Текст с визуальной картой имеет конкурентное преимущество - читатель больше не ощущает, что на него перекладывают рутину анализа и, возможно, пытаются манипулировать мнением. Карта отображает суть и фильтрует информационный шум.</p>

      <p>Карты доступны для совместного редактирования, поэтому, вместо размытых комментариев читатели смогут присылать конструктивные дополнения к вашей статье.</p>
    </div>
