...
<div class="box2">
  <div class="container padding50">
    ...
    <div class="col-sm-7 noleft">
      ...
      <p>Часто сложно оценить правдоподобность утверждений автора, читая текст полный описаний и лирических отступлений. Сложно выделить факты, на которых основаны утверждения, определить их достоверность и проверить корректность логики.</p>

      <p>Визуальные карты grasp.how помогают понять взаимосвязи фактов и утверждений и показывают насколько тексту можно доверять.</p>

      <p>Имея перед глазами визуальную карту читатель больше не чуствует, что на него перекладывают рутину анализа и, возможно, пытаются манипулировать мнением. Карта отображает суть и фильтрует информационный шум.</p>

      <p>И, самое главное, карты доступны для совместного редактирования. Это значит что если вы заметили в чужой карте неточность, вы можете сразу её исправить.
        А если автор карты вы сами, то ваши читатели будут присылать конструктивные дополнения вместо размытых комментариев.</p>
    </div>
